// gridp5.js
// Has a grid like grid.js but with a p5 sketch embedded.
...
src(s0).scrollY(() => changeDirection(0, time, 0.05)).scrollX(() => changeDirection(0, time, 0.05)).add(
  shape(2, 0.01, 0.001).scrollY(0.25)
    ...
    .add(shape(2, 0.01, 0.001).rotate(Math.PI / 2).scrollX(0.25)
      .add(shape(2, 0.01, 0.001).rotate(Math.PI / 2).scrollX(-0.25))
      .scrollX(() => changeDirection(0, time, 0.05))).add(o1))
  .repeat(4, 4).out(o0);
